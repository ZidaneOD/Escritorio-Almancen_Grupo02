...
public class CMCambiarProductoHashSet implements CICambioAlmacen<CEProducto> {
    ...
    public CMCambiarProductoHashSet() {
        ...
        oHsData.add(new CEProducto("93132401", "TURBO", "MAX", "CA001", "S005", "MR001", 65.0, "UN002", 30, "UND", "EM001", 1, "link"));
        oHsData.add(new CEProducto("79088558", "FRIO RICO", "CON ALMENDRA", "CA003", "S002", "MR001", 93.0, "UN002", 15, "UND", "EM001", 1, "link"));
